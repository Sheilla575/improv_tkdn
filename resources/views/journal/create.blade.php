...
<div class="space-y-6">
    ...
    <div class="max-w-4xl">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('master.journal.store') }}" method="POST" class="space-y-6" id="materialForm">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="spesifikasi_or_kualifikasi" id="specification" class="form-input pl-10 @error('spesifikasi_or_kualifikasi') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('spesifikasi_or_kualifikasi') }}" placeholder="Enter specifications">
                            </div>
                            @error('specification')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="specification" class="form-input pl-10 @error('classification_tkdn') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="Peralatan (Jasa Umum)">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="negara_asal" id="negara_asal" class="form-input select2 pl-10 @error('negara_asal') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">
                                    <option value="{{ old('negara_asal') }}">Pilih Kewarganegaraan</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- <div>
                            <label for="brand" class="form-label">Satuan atau Durasi</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="satuan_harga" id="price" value="{{ old('satuan_harga') ? number_format(old('price'), 0, ',', '.') : '' }}" class="form-input pl-10 w-full @error('price') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" required placeholder="Masukkan harga peralatan">
                            </div>
                            @error('price')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="keterangan" id="description" class="form-input pl-10 @error('keterangan') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('keterangan') }}" placeholder="Enter additional notes">
                            </div>
                            @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
